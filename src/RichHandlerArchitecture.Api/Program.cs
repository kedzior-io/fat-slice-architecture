...
using RichHandlerArchitecture.Handlers.Handlers.Customers.Queries;
using RichHandlerArchitecture.Handlers.Handlers.Customers.Commands;
using RichHandlerArchitecture.Handlers.Handlers.Addresses.Queries;
using RichHandlerArchitecture.Handlers.Handlers.Addresses.Commands;
using RichHandlerArchitecture.Handlers.Handlers.Products.Queries;
using RichHandlerArchitecture.Handlers.Handlers.Products.Commands;
using RichHandlerArchitecture.Handlers.Handlers.Orders.Queries;
using RichHandlerArchitecture.Handlers.Handlers.Orders.Commands;
